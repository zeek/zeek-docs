...
.. zeek:id:: Storage::Async::close_backend
   :source-code: base/frameworks/storage/async.zeek 78 81
...
.. zeek:id:: Storage::Async::erase
   :source-code: base/frameworks/storage/async.zeek 93 96
...
.. zeek:id:: Storage::Async::open_backend
   :source-code: base/frameworks/storage/async.zeek 73 76

   :Type: :zeek:type:`function` (btype: :zeek:type:`Storage::Backend`, config: :zeek:type:`Storage::BackendOptions`, key_type: :zeek:type:`any`, val_type: :zeek:type:`any`) : :zeek:type:`Storage::OperationResult`
...
.. zeek:id:: Storage::Async::put
   :source-code: base/frameworks/storage/async.zeek 83 86
